...
//				if (!is_dir($options['dir'])) {
				if (!is_dir(WWW_ROOT . $options['dir'])) {
//[GDA]
					if ($options['createDirectory']) {
						$folder = &new Folder();
//[GDA]
//						if (!$folder->create($options['dir'])) {
						if (!$folder->create(ROOT . DS . $options['dir'])) {
//[GDA]
...
//				if (!is_writable($options['dir'])) {
				if (!is_writable(WWW_ROOT . $options['dir'])) {
//[GDA]
...
//				$saveAs = $options['dir'] . DS . $data[$model->alias][$options['uploadName']] . '.' . $sub;
				$saveAs = WWW_ROOT . $options['dir'] . DS . $data[$model->alias][$options['uploadName']] . '.' . $sub;
//[GDA]
...
//					$saveAs = $options['dir'] . DS . $data[$model->alias][$options['uploadName']].'.'.$ext;
					$saveAs = WWW_ROOT . $options['dir'] . DS . $data[$model->alias][$options['uploadName']].'.'.$ext;
//[GDA]
				} else {
//[GDA]
//					$saveAs = $options['dir'] . DS . $data[$model->alias][$fieldName]['name'];
					$saveAs = WWW_ROOT . $options['dir'] . DS . $data[$model->alias][$fieldName]['name'];
//[GDA]
				}
